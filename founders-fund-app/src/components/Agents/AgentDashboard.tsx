...
export default function AgentDashboard({ portfolioId }: AgentDashboardProps) {
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage up to 20 automated meme coin trading agents</p>
        </div>
        <button
